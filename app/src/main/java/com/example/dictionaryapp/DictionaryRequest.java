...
public class DictionaryRequest extends AsyncTask<String, Integer, String>{
    Context context;
    TextView showDef;
    DictionaryRequest(Context _context,TextView tv)
    {
...
protected String doInBackground(String... params) {
    ...
    final String app_id = "431877c0";
    final String app_key = "16d034f30cb77b1c918a13f9dc994c04";
    try {
        ...
        protected void onPostExecute(String result) {
           ...
           catch (JSONException e)
           {
            ...
            Log.v("result of Dictionary","onPostExcuse"+result);
        }
}
